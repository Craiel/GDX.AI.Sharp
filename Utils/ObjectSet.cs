namespace GDX.AI.Sharp.Utils
{
    ...
    public class ObjectSet<T> : IEnumerable<T>
    {
        ...
        public ObjectSet(int initialCapacity = 51, float loadFactor = 0.8f)
        {
            ...
            this.hashShift = 31 - this.capacity.NumberOfTrailingZeros();
        ...
        public void Shrink(int maxCapacity)
        {
            ...
            maxCapacity = MathUtils.NextPowerOfTwo(maxCapacity);
        ...
        private void EnsureCapacity(int additionalCapacity)
        {
            ...
            {
                this.Resize(MathUtils.NextPowerOfTwo((int)Math.Ceiling(sizeNeeded / this.loadFactor)));
            }
        }
        ...
        private void Resize(int newSize)
        {
            ...
            this.mask = newSize - 1;
            this.hashShift = 31 - newSize.NumberOfTrailingZeros();
