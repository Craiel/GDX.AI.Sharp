...
{
    // Based on https://github.com/codecapers/Fluent-Behaviour-Tree
    public class BehaviorTreeBuilder
    {
        /*private IBehaviorTreeNode currentNode;
        
        private readonly Stack<IBehaviorTreeParentNode> parentNodeStack;

        public BehaviorTreeBuilder()
        {
            this.parentNodeStack = new Stack<IBehaviorTreeParentNode>();
        }

        // Action node
        public BehaviorTreeBuilder Do(string name, Func<TimeData, BTTaskStatus> fn)
        {
