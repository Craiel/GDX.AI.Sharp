...
void RecastWrapper::RecastClient::buildStep1InitConfig()
{
	const float* bmin = m_geom->getNavMeshBoundsMin();
	const float* bmax = m_geom->getNavMeshBoundsMax();
...
bool RecastWrapper::RecastClient::buildStep2Rasterize()
{
	const float* verts = m_geom->getMesh()->getVerts();
	const int nverts = m_geom->getMesh()->getVertCount();
	const int* tris = m_geom->getMesh()->getTris();
...
void RecastWrapper::RecastClient::buildStep3FilterWalkable()
{
...
bool RecastWrapper::RecastClient::buildStep4PartitionWalkableSurface()
{
...
bool RecastWrapper::RecastClient::buildStep5TraceAndSimplify()
{
	// Create contours.
...
bool RecastWrapper::RecastClient::buildStep6BuildPolygons()
{
...
bool RecastWrapper::RecastClient::buildStep7CreateDetailMesh()
{
